  ...
  <div class="page-header section-dark" style="background-image: url('./assets/img/antoine-barres.jpg')">
    ...
    <div class="content-center">
      <div class="container">
        ...
        <h5 style="color: white;margin-bottom: 40px; background-color: rgba(255, 255, 255,0.1); padding: 10px;border-radius: 5px; text-align: center;">Laporan Pengeluaran Uang</h5>
      ...
      <table class="table table-hover" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="color: white;">Rp. {{number_format($l->pengeluaran) }}</td>
